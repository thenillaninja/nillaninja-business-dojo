...
import {
  localRestaurant
} from "./mock-businesses/local-restaurant.js?mock=6";
...
const answers = createAnswers(
  businessAssessmentQuestions,
  localRestaurant.answerOptionIds
);
...
const recommendations = generateRecommendations(
  ...
  answers,
  6,
  localRestaurant.profile.currentPriority
);

console.log("MOCK BUSINESS");
console.log(localRestaurant.profile.businessName);
console.log();
