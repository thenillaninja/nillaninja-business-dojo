...
import {
  soloLandscapingContractor
} from "./mock-businesses/solo-landscaping-contractor.js?mock=2";
...
const answers = createAnswers(
  businessAssessmentQuestions,
  soloLandscapingContractor.answerOptionIds
);
...
const recommendations = generateRecommendations(
  ...
  answers,
  6,
  soloLandscapingContractor.profile.currentPriority
);

console.log("MOCK BUSINESS");
console.log(soloLandscapingContractor.profile.businessName);
console.log();
