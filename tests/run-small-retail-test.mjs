...
import {
  smallRetailStore
} from "./mock-businesses/small-retail-store.js?mock=3";
...
const answers = createAnswers(
  businessAssessmentQuestions,
  smallRetailStore.answerOptionIds
);
...
const recommendations = generateRecommendations(
  ...
  answers,
  6,
  smallRetailStore.profile.currentPriority
);

console.log("MOCK BUSINESS");
console.log(smallRetailStore.profile.businessName);
console.log();
