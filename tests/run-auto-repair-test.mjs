...
import {
  independentAutoRepairShop
} from "./mock-businesses/independent-auto-repair-shop.js?mock=4";
...
const answers = createAnswers(
  businessAssessmentQuestions,
  independentAutoRepairShop.answerOptionIds
);
...
console.log(independentAutoRepairShop.profile.businessName);
console.log();
