...
export const businessAssessmentQuestions = [
  ...
  },
  {
    ...
    question: "Does your business avoid entering the same information into multiple systems, documents, or spreadsheets?",
    helpText: "Consider whether customer details and other business information flow between forms, invoices, calendars, spreadsheets, or software tools without repeated manual entry.",
    responseType: "single-choice",
    options: standardAnswerOptions,
    weight: 2,
    recommendationKeys: [
